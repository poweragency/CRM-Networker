...
**COSA MANCA (prossimi step, ordine in 00-README §7):** **Slice Analytics** (dashboard/funnel/conversion/team/branch, classifiche, report/export, notifiche), **Slice Admin** (pre-registrazione, attivazioni, ranghi, audit, impostazioni org); **Edge Functions Deno** (create-invitation/activate-account, generate-report-export, pg_net cron fan-out); generazione tipi TS dal DB; provisioning Supabase reale + applicazione migration; Realtime; test; hardening.
