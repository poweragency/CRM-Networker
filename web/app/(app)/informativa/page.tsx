...
import { LibriModal } from '@/components/informativa/libri-modal';
...
export default async function InformativaPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Downloadable documents (admin / co-admin managed) + tasto "Libri" (modale) */}
      <section className="space-y-4">
        <div className="flex items-center justify-between gap-3">
          <h2 className="text-lg font-semibold tracking-tight text-foreground">
            {t('pdf_title')}
          </h2>
          {/* La libreria Libri non è più una sezione: si apre da questo tasto. */}
          <LibriModal books={books} />
        </div>
